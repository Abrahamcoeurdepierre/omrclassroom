...
function Classes(props) {
    ...
    const deleteAction = () => {
        ...
        db.collection('Users').doc(`${currentUser.uid}`).collection("Classes").doc(props.id).delete()
    }
    const cancelAction = () => {
        setToggleDelete('hidden')
    ...
    const editAction = () =>{
        db.collection('Users').doc(`${currentUser.uid}`).collection("Classes").doc(props.id).set({
            Name: editInput,
  ...
  <>
    ...
    <div className='subject'>
            <Link className='link empty' to={`/class/` + props.id}>
                <div className=''></div>
            </Link>   
